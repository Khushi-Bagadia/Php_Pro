                            ...
                            <?php
                                ...
                                foreach($subcategory_arr as $subcategory)
                                {
                                    ...
                                    {  ?>
                                            ...
                                            <li>
                                                <!-- <a class="text-decoration-none" href="shop-subcategory?name=<?= $subcategory->name; ?> "> <?= $subcategory->name; ?> </a> -->

                                                <a class="text-decoration-none" href="shop-subcategory?id=<?= $subcategory->id; ?> "> <?= $subcategory->name; ?> 
                            ...
                            <div class="card rounded-0">
                                ...
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white" href="shop-single?id=<?= $product->id; ?>"><i class="far fa-heart"></i></a></li>
                                        <li><a class="btn btn-success text-white mt-2" href="shop-single?id=<?= $product->id; ?>"><i class="far fa-eye"></i>Click here</a></li>
